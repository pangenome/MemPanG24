...
- link:https://www.linkedin.com/in/shelbysolomondarnell/?originalSubdomain=ke[Shelby Solomon Darnell], University of Tennessee Health Science Center, Memphis, TN, US
- link:https://uni-tuebingen.de/en/research/research-infrastructure/quantitative-biology-center-qbic/team/[Simon Heumos], Quantitative Biology Center (QBiC), Tübingen, BW, DE
